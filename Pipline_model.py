...
test_image1 = tf.keras.utils.load_img(path, target_size=(224,224))
test_image1_array = tf.keras.utils.img_to_array(test_image1)/255.0
h,w,d = test_image.shape

test_figure = px.imshow(test_image)
test_figure.update_layout(width = 700, height = 500, margin = dict(l=10, r=10, b=10, t=10), xaxis_title="Image 16")
